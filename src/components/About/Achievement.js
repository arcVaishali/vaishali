  ...
  return (
    <div className="grid grid-cols-12 col-span-12 p-32 m-4">
      <div className="grid grid-cols-12 col-span-12 justify-center items-center">
        ...
        <animated.button
          style={{ ...style1 }}
          className="col-span-2 bg-black p-4 text-white border-2 border-black rounded-full hover:bg-white hover:text-black text-sm"
        >
          Get in Touch
        </animated.button>
      </div>
      <div className="grid grid-col-12 col-span-12 p-4 mt-8">
        {cols.map((ele, idx) => (
          <div
            ...
            className="grid grid-cols-12 col-span-6 gap-8"
          >
